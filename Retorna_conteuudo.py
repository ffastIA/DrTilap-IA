...
def gerar_relatorio(diretorio_raiz, arquivo_saida, extensoes=None):
    ...
    if extensoes is not None:
        # garante que seja tupla para usar no endswith
...
# Uso
diretorio = r'C:\Users\usuario\OneDrive - Engine Tecnologia\Projetos\Python\DrTilapIA'  # Ex: 'meu_projeto'
extensoes_desejadas = ('.py')  # ajuste como quiser
