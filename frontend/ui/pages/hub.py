...
def hub() -> rx.Component:
    return rx.box(
        ...
        rx.center(
            rx.heading(f"Olá, {State.user_name}", size="8", color=WHITE, position="absolute", top="10%"),
        ),
        floating_card("Consultoria", "Chat IA RAG", "/consultoria", "message-square", top="40%", left="15%"),
        floating_card("Dashboard", "Métricas Reais", "/dashboard", "bar-chart-3", top="40%", right="15%"),
        floating_card("Admin RAG", "Gestão de Base", "/admin-rag", "database", bottom="15%", left="43%"),
        rx.button(
            "Sair",
